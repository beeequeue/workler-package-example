//#region ../node_modules/.pnpm/solid-js@1.9.12/node_modules/solid-js/dist/dev.js
var sharedConfig = {
	context: void 0,
	registry: void 0,
	effects: void 0,
...
//#endregion
//#region ../node_modules/.pnpm/solid-js@1.9.12/node_modules/solid-js/web/dist/dev.js
...
//#endregion
//#region ../pkg/dist/capture.worklet.mjs?worker
function WorkerWrapper(options) {
	return new Worker("/assets/capture.worklet-D2nT03lR.js", { name: options?.name });
}
//#endregion
//#region ../pkg/dist/index.mjs
var audioContext = new AudioContext();
await audioContext.audioWorklet.addModule(WorkerWrapper);
//#endregion
//#region src/App.tsx
var _tmpl$ = /* @__PURE__ */ template(`<section id=center><div class=hero></div><div><h1>Get started</h1><p>Edit <code>src/App.tsx</code> and save to test <code>HMR</code></p></div><button type=button class=counter>Count is `), _tmpl$2 = /* @__PURE__ */ template(`<div class=ticks>`), _tmpl$3 = /* @__PURE__ */ template(`<section id=spacer>`);
function App() {
	const [count, setCount] = createSignal(0);
	audioContext.close();
	return [
		(() => {
			var _el$ = _tmpl$(), _el$4 = _el$.firstChild.nextSibling.nextSibling;
			_el$4.firstChild;
			_el$4.$$click = () => setCount((count) => count + 1);
			insert(_el$4, count, null);
			return _el$;
		})(),
		_tmpl$2(),
		_tmpl$3()
